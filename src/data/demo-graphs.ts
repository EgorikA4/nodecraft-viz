...
export const demoGraphs: GraphDocument[] = [
  {
    ...
    nodes: [
      ...
      { id: 'n2', type: 'OrgUnit', label: 'Engineering', description: 'Software engineering department', data: { name: 'Engineering Department', code: 'ENG-01', type: 'Department' }, position: { x: 200, y: 200 } },
      { id: 'n3', type: 'OrgUnit', label: 'Human Resources', description: 'HR department', data: { name: 'HR Department', code: 'HR-01', type: 'Department' }, position: { x: 600, y: 200 } },
      { id: 'n4', type: 'Position', label: 'CTO', description: 'Chief Technology Officer', data: { name: 'Chief Technology Officer', grade: 'C-Level' }, position: { x: 100, y: 370 } },
      { id: 'n5', type: 'Position', label: 'Senior Engineer', description: 'Senior Software Engineer', data: { name: 'Senior Software Engineer', grade: 'Senior' }, position: { x: 300, y: 370 } },
      { id: 'n6', type: 'Position', label: 'HR Manager', description: 'Human Resources Manager', data: { name: 'HR Manager', grade: 'Manager' }, position: { x: 600, y: 370 } },
